...
imageDir = fullfile(dataSetDir,'sparse75');
...
imageFolder = fullfile(dataSetDir,'imagesResized_75_concatenate',filesep);
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\orig\combine1_75');
pxdsTestResults1 = semanticseg(imdsTest1, orignet75, "WriteLocation", newimageDir,'MiniBatchSize',16);
%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\orig\combine1test_75');
pxdsTrainResults1= semanticseg(imdsTrain1, orignet75, "WriteLocation", newimageDir,'MiniBatchSize',8);
...
imageFolder = fullfile(dataSetDir,'imagesResized_concatenate',filesep);
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample2\combine2_75');
pxdsTestResults2 = semanticseg(imdsTest2, downsample2net75, "WriteLocation", newimageDir,'MiniBatchSize',8);
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample2\combine2test_75');
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample4\combine4_75');
pxdsTestResults4 = semanticseg(imdsTest4, downsample4net75, "WriteLocation", newimageDir);
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample4\combine4test_75');
...
imageFolder = fullfile('C:\sea urchin\Hiearhical network\data\combine\combineTest_75');
% index=1;
...
imageFolder = fullfile('C:\sea urchin\Hiearhical network\data\combine\combineTrain_75');
...
subplot(224);imagesc(I(:,:,4));axis image;colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\final_75');
