...
imageDir = fullfile(dataSetDir,'sparse75_nophase');
...
imageFolder = fullfile(dataSetDir,'imagesResized_75_nophase_concatenate',filesep);
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\orig\combine1_75_nophase');
pxdsTestResults1 = semanticseg(imdsTest1, orignet75, "WriteLocation", newimageDir,'MiniBatchSize',16);
%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\orig\combine1test_75_nophase');
pxdsTrainResults1= semanticseg(imdsTrain1, orignet75, "WriteLocation", newimageDir,'MiniBatchSize',4);
...
%%
downsample2net75 = net;
save('downsample2net75.mat','downsample2net75')
%% test
load downsample2net75
clf
% reset(imdsTest2)
% reset(pxdsTest2)
I = read(imdsTest2);
C = semanticseg(I, downsample2net75);
B = rgb2gray(labeloverlay(I,C));
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample2\combine2_75_nophase');
pxdsTestResults2 = semanticseg(imdsTest2, downsample2net75, "WriteLocation", newimageDir,'MiniBatchSize',8);
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample2\combine2test_75_nophase');
pxdsTrainResults2= semanticseg(imdsTrain2, downsample2net75, "WriteLocation", newimageDir,'MiniBatchSize',8);
...
%%
downsample4net75 = net;
save('downsample4net75.mat','downsample4net75')
%% test
load downsample4net75
clf
%
% reset(imdsTest4)
% reset(pxdsTest4)
I = read(imdsTest4);
C = semanticseg(I, downsample4net75);
B = rgb2gray(labeloverlay(I,C));
...
colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample4\combine4_75_nophase');
pxdsTestResults4 = semanticseg(imdsTest4, downsample4net75, "WriteLocation", newimageDir);
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\downsample4\combine4test_75_nophase');
pxdsTrainResults4 = semanticseg(imdsTrain4, downsample4net75, "WriteLocation", newimageDir);
...
imageFolder = fullfile('C:\sea urchin\Hiearhical network\data\combine\combineTest_75_nophase');
% index=1;
...
imageFolder = fullfile('C:\sea urchin\Hiearhical network\data\combine\combineTrain_75_nophase');
...
%%
combinenet75 = net;
save('combinenet75.mat','combinenet75');
%%
clf
% load combinenet75
net = combinenet75;
...
subplot(224);imagesc(I(:,:,4));axis image;colormap gray
%%
newimageDir = fullfile('C:\sea urchin\Hiearhical network\data\final_75_nophase');
